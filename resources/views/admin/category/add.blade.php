                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            ...
                            <div class="widget-title am-fl">新增栏目</div>
                        ...
                        <div class="widget-body am-fr">
                            ...
                            @endif
                            <form class="am-form tpl-form-line-form" method="post" action="{{url('admin/category')}}">
                                {{--用户--}}
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" name="type_name" id="type_name" value="" placeholder="">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <div class="tpl-switch">
                                            <input type="checkbox" name="status" value="1" class="ios-switch bigswitch tpl-switch-btn" checked="">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" name="path" id="path" value="" placeholder="">
                                        <small>栏目名称2-16位。</small>
                                    </div>
                                </div>
