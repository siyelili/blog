            ...
            <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                <div class="widget am-cf">
                    ...
                    <div class="widget-body  am-fr">
                        ...
                        <form action="{{url('admin/album')}}" method="get" id="formType">
                            <div class="am-u-sm-12 am-u-md-6 am-u-lg-3">
                                <div class="am-form-group tpl-table-list-select">
                                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                                        <select name="typeid" data-am-selected="{btnSize: 'sm'}" onchange="typeFound();">
                        ...
                        <form action="{{url('admin/album')}}" method="get" id="formName">
                            <input type="hidden" name="_token" value="{{csrf_token()}}">
...
<script>
   function addurl(){
       location.href= "{{url('admin/album/create')}}"
   }
...
//分页查询
   ...
   function delUser(pid) {
       layer.confirm('您确定要删该管理员吗？', {
           ...
           $.post("{{url('admin/album/')}}/"+pid,{'_method':'delete','_token':"{{csrf_token()}}"},function (data) {
                         console.info(data);
               if(data.status==1){
